...
ops.element('quad', 11, 11, 12, 22, 21, 'PlaneStress', 1, 1)
ops.element('quad', 12, 12, 13, 23, 22, 'PlaneStress', 1, 2)
ops.element('quad', 13, 13, 14, 24, 23, 'PlaneStress', 1, 2)
ops.element('quad', 21, 21, 22, 32, 31, 'PlaneStress', 1, 2)
ops.element('quad', 22, 22, 23, 33, 32, 'PlaneStress', 1, 2)
ops.element('quad', 23, 23, 24, 34, 33, 'PlaneStress', 1, 2)
ops.element('quad', 31, 31, 32, 42, 41, 'PlaneStress', 1, 2)
ops.element('quad', 32, 32, 33, 43, 42, 'PlaneStress', 1, 2)
ops.element('quad', 33, 33, 34, 44, 43, 'PlaneStress', 1, 2)
