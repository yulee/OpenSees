...
ops.timeSeries('Path', 1, '-dt', 0.02, '-values', *accel_values.tolist(), '-factor', 1.0)
ops.timeSeries('Path', 2, '-dt', 0.02, '-values', *vel_values.tolist(), '-factor', 1.0)
ops.timeSeries('Path', 3, '-dt', 0.02, '-values', *disp_values.tolist(), '-factor', 1.0)
